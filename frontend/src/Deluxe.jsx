                ...
                <div className="flex flex-col items-center justify-center border-2 border p-4 rounded-lg bg-booking">
                    <div className="flex items-center justify-center bg-black text-white opacity-70 p-4 rounded-md w-7/8 h-4/5">
                        ...
                        <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                            ...
                            <Datepicker id="datepicker" toggle className="w-4/5 text-black bg-gray-700" displayFormat="DD/MM/YYYY" useRange={false} value={date} onChange={newValue => setValue(newValue)} showFooter={true} showShortcuts={true} configs={{shortcuts: {today: "Today",  currentMonth: "CurrentMonth"}, footer: { cancel: "Cancel",   apply: "Apply"  }}} />
                            <br></br>
                            <label className="text-lex text-white font-medium font-bold">Customer Requests and Inquiries</label>
                            <textarea id="message" rows="5" className="p-2.5 w-full text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Leave a Comment...." value={comment}></textarea>
                            <br></br>
