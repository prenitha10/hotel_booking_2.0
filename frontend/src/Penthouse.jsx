...
import { faUsers, faBed, faWifi, faTv, faCoffee, faShower, faConciergeBell, faBriefcase, faUtensils, faBroom ,faLock,faWindowMaximize,faWineGlass,faHotTub} from '@fortawesome/free-solid-svg-icons';
...
const profile = [
    ...
    {
        label: "Wine and Champagne Selection",
        icon: <FontAwesomeIcon icon={faWineGlass} size="1x" />,
    },
    {
        label: "Hot Tub",
        icon: <FontAwesomeIcon icon={faHotTub} size="1x" />,
    },
...
function Penthouse() {
    ...
    return (
        <div>
            ...
            <div>
                <p className="p-2 text-[30px] font-bold text-center">Penthouse Suite</p>
            </div>
            <div className="pl-10 pr-10 grid grid-cols-2 gap-10">
                <div className="flex flex-col items-center justify-center border-2 border p-4 rounded-lg">
                    <img className="h-80 w-120" src="/src/images/penthouse.png" alt="Penthouse Suite" />
                    <p className="text-[15px] text-center mt-3">
                    Experience luxury in our Penthouse Suite, featuring expansive views, opulent furnishings, top-tier amenities, and unparalleled comfort for an extraordinary stay.</p>
                    ...
                    <p className="font-bold">Rs.10000/- only with taxes</p>
                </div>
