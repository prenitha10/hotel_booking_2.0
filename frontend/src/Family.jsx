...
import { faUsers, faBed, faWifi, faTv, faCoffee, faShower, faConciergeBell, faBriefcase, faUtensils, faBroom ,faLock} from '@fortawesome/free-solid-svg-icons';
...
function Family() {
    ...
    return (
        <div>
            ...
            <div>
                <p className="p-2 text-[30px] font-bold text-center">Family Suite</p>
            </div>
            <div className="pl-10 pr-10 grid grid-cols-2 gap-10">
                <div className="flex flex-col items-center justify-center border-2 border p-4 rounded-lg">
                    <img className="h-80 w-120" src="/src/images/family.png" alt="Family Suite" />
                    <p className="text-[15px] text-center mt-3">
                    Unwind with the whole family in our spacious Family Suite, featuring multiple beds, kid-friendly amenities, cozy furnishings, and ample room for everyone.
                    </p>
                    ...
                    <p className="font-bold">Rs.3500/- only with taxes</p>
                </div>
