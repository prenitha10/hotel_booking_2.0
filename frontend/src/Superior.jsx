...
import { faUsers, faBed, faWifi, faTv, faCoffee, faShower, faConciergeBell, faBriefcase, faUtensils, faBroom } from '@fortawesome/free-solid-svg-icons';
...
function Superior() {
    ...
    return (
        <div>
            ...
            <div>
                <p className="p-2 text-[30px] font-bold text-center">Superior Suite</p>
            </div>
            <div className="pl-10 pr-10 grid grid-cols-2 gap-10">
                <div className="flex flex-col items-center justify-center border-2 border p-4 rounded-lg">
                    <img className="h-80 w-120" src="/src/images/superior.png" alt="Superior Suite" />
                    <p className="text-[15px] text-center mt-3">
                    Indulge in extra space and style in our Superior Suite, offering plush bedding, upgraded amenities, elegant furnishings, and enhanced comfort for a refined stay.
                    </p>
                    ...
                    <p className="font-bold">Rs.3000/- only with taxes</p>
                </div>
