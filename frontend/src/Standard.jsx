...
import { faUsers, faBed, faWifi, faTv,faShower, faConciergeBell, faBriefcase, faUtensils, faBroom } from '@fortawesome/free-solid-svg-icons';
...
function Standard() {
    ...
    return (
        <div>
            ...
            <div>
                <p className="p-2 text-[30px] font-bold text-center">Standard Suite</p>
            </div>
            <div className="pl-10 pr-10 grid grid-cols-2 gap-10">
                <div className="flex flex-col items-center justify-center border-2 border p-4 rounded-lg">
                    <img className="h-80 w-120" src="/src/images/standard.png" alt="Standard Suite" />
                    <p className="text-[15px] text-center mt-3">
                    Enjoy a relaxing stay in our inviting Standard Suite, equipped with essential amenities, comfortable bedding, modern decor, and thoughtful touches for comfort.
                    </p>
                    ...
                    <p className="font-bold">Rs.2500/- only with taxes</p>
                </div>
